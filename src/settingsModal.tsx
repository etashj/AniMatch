...
export default function Settings( {visible, onClose, theme, setTheme, hideMature, hideEcchi, toggleMature, toggleEcchi} : Props ) {
  ...
  return (
    <div className="dark:text-zinc-200 bg-zinc-200 dark:bg-[#141112] px-2 py-2 rounded-3xl fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 fixed flex-column flex-nowrap justify-between space-y-2">

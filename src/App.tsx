    ...
    <>
      <div id='mainCont' className={`${settingsVisible? 'blur-xs' : ''} transition duration-300`}>
        <div id='header' className='flex flex-row flex-nowrap justify-between'>
          <h1 className="font-header font-bold text-4xl dark:text-zinc-200">AniMatch</h1>
          <div id='btnCont' className="font-sans flex flex-row flow-nowrap justify-left">
            <button className='text-zinc-200 bg-[#1D2126] dark:bg-[#24272a] px-4 rounded-2xl sm:rounded-2xl hover:shadow-xl/20 dark:hover:shadow-indigo-500 transition duration-300 active:shadow-md/40' onClick={() => setCount((count) => count + 1)}>
